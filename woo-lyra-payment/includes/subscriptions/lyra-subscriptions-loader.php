...
class Lyra_Subscriptions_Loader
{
    private static $handlers = array(
        'wc-subscriptions' => 'Lyra_WC_Subscriptions_Subscriptions_Handler',
        'subscriptio' => 'Lyra_Subscriptio_Subscriptions_Handler'
    );
    ...
    public static function getInstance($handler)
    {
        ...
        include_once 'lyra-subscriptions-handler-interface.php';
        include_once "lyra-$handler-subscriptions-handler.php";
