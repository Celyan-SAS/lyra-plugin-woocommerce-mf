...
class Lyra_Subscriptio_Subscriptions_Handler implements Lyra_Subscriptions_Handler_Interface
{
    /**
     * {@inheritDoc}
    ...
    public function process_subscription_renewal($order, $response)
    {
        ...
        if ($renewal_order_id = (int) $subscription->last_order_id) { // Get last generated order.
            ...
            if (LyraTools::is_hpos_enabled()) {
                ...
                $renewal_order->update_meta_data('Subscription amount', WC_Gateway_Lyra::display_amount($response->get('sub_amount'), $currency_code));
                ...
                update_post_meta($renewal_order_id, 'Subscription amount', WC_Gateway_Lyra::display_amount($response->get('sub_amount'), $currency_code));
