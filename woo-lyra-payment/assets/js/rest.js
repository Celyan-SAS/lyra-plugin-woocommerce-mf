...
var lyraInitRestEvents = function(KR) {
    KR.onError(function(e) {
        jQuery('#lyrastd_rest_processing').css('display', 'none');
...
var lyraDrawRestPaymentFields = function(formToken, first) {
    ...
    setTimeout(function () {
        KR.setFormConfig(lyraFormConfig).then(function(v) {
            if (first) {
                lyraInitRestEvents(v.KR);
            }
        });
    }, 300);
};
