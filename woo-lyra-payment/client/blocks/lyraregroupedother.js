...
const PAYMENT_METHOD_NAME = 'lyraregroupedother';
var lyra_data = getLyraServerData(PAYMENT_METHOD_NAME);

const Content = () => {
    var fields = <ul dangerouslySetInnerHTML={{__html: lyra_data?.payment_fields}} />;
    jQuery('.wc-block-components-checkout-place-order-button').on('click', lyra_get_selected_option(['lyraregroupedother_card_type']));
