=== Lyra Collect for WooCommerce ===
Contributors: Lyra Network, Alsacréations
Tags: payment, Lyra Collect, gateway, checkout, credit card, bank card, e-commerce
...
This plugin links your WordPress WooCommerce shop to the Lyra Collect payment gateway.
...
1. Upload the folder `woo-lyra-payment` to the `/wp-content/plugins/` directory
...
1. Lyra Collect general configuration.
2. Lyra Collect standard payment configuration.
3. Lyra Collect payment in installments configuration.
4. Lyra Collect payment options in checkout page.
5. Lyra Collect payment page.
...
* Added payment by token (requires Lyra Collect payment by token option).
